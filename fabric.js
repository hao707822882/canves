...
var Cufon = function () {
    ...
    }, m = " ".split(/\s+/).length == 0, g = new o, y = new s, b = [], w = {}, E = {}, S = {
        engine: null,
        hover: !1,
        hoverables: {a: !0},
        printable: !0,
...
JSON || (JSON = {}), function () {
    ...
    function o(e) {
        ...
        var t = +(new Date), n = e.duration || 500, r = t + n, i, s = e.onChange || function () {
            ...
            }, f = "startValue"in e ? e.startValue : 0, l = "endValue"in e ? e.endValue : 100, c = e.byValue || l - f;
        e.onStart && e.onStart(), function h() {
            i = +(new Date);
            var l = i > r ? n : i - t;
            s(u(l, f, c, n));
            if (i > r || o()) {
    ...
    fabric.util = {};
    var n = Math.PI / 180, u = fabric.window.requestAnimationFrame || fabric.window.webkitRequestAnimationFrame || fabric.window.mozRequestAnimationFrame || fabric.window.oRequestAnimationFrame || fabric.window.msRequestAnimationFrame || function (e) {
    ...
    function s() {
        ...
        var n = null, s = e.call(arguments, 0);
    ...
    var d = function (e) {
        var t = fabric.document.documentElement, n = fabric.document.body || {scrollLeft: 0};
        return e.pageX || (typeof e.clientX != "unknown" ? e.clientX : 0) + (t.scrollLeft || n.scrollLeft) - (t.clientLeft || 0)
    }, v = function (e) {
        var t = fabric.document.documentElement, n = fabric.document.body || {scrollTop: 0};
    ...
    function v(e, n, r) {
        function i(i) {
            ...
            t.parseSVGDocument(s.documentElement, function (r, i) {
                d.set(e, {objects: t.util.array.invoke(r, "toObject"), options: i}), n(r, i)
            }, r)
        }
    ...
    var t = e.fabric || (e.fabric = {}), n = t.util.object.extend, r = t.util.string.capitalize, i = t.util.object.clone, s = {
        cx: "left",
        x: "left",
        cy: "top",
        y: "top",
    ...
    t.parseTransformAttribute = function () {
        ...
        var s = [1, 0, 0, 1, 0, 0], o = "(?:[-+]?\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?)", u = "(?:\\s+,?\\s*|,\\s*)", a = "(?:(skewX)\\s*\\(\\s*(" + o + ")\\s*\\))", f = "(?:(skewY)\\s*\\(\\s*(" + o + ")\\s*\\))", l = "(?:(rotate)\\s*\\(\\s*(" + o + ")(?:" + u + "(" + o + ")" + u + "(" + o + "))?\\s*\\))", c = "(?:(scale)\\s*\\(\\s*(" + o + ")(?:" + u + "(" + o + "))?\\s*\\))", h = "(?:(translate)\\s*\\(\\s*(" + o + ")(?:" + u + "(" + o + "))?\\s*\\))", p = "(?:(matrix)\\s*\\(\\s*(" + o + ")" + u + "(" + o + ")" + u + "(" + o + ")" + u + "(" + o + ")" + u + "(" + o + ")" + u + "(" + o + ")" + "\\s*\\))", d = "(?:" + p + "|" + h + "|" + c + "|" + l + "|" + a + "|" + f + ")", v = "(?:" + d + "(?:" + u + d + ")*" + ")", m = "^\\s*(?:" + v + "?)\\s*$", g = new RegExp(m), y = new RegExp(d);
        return function (o) {
            var u = s.concat();
            return !o || o && !g.test(o) ? u : (o.replace(y, function (s) {
                var o = (new RegExp(d)).exec(s).filter(function (e) {
                    return e !== "" && e != null
                }), a = o[1], f = o.slice(2).map(parseFloat);
                switch (a) {
                    case"translate":
                        i(u, f);
                        break;
        ...
        return function (n, o, u) {
            ...
            var v = n.getAttribute("viewBox"), m = n.getAttribute("width"), g = n.getAttribute("height"), y = null, b = null, w, E;
    ...
    function e(e) {
        ...
        if (t) {
            ...
            for (var r = n.length; r--;) {
                var i = n[r].split(/\s*:\s*/), s = i[0].trim(), o = i[1].trim();
    ...
    function t(e, t) {
        for (var n in t) {
            if (typeof t[n] == "string" && /^\d+%$/.test(t[n])) {
                ...
                if (n === "x1" || n === "x2")t[n] = e.width * r / 100; else if (n === "y1" || n === "y2")t[n] = e.height * r / 100
            }
            if (n === "x1" || n === "x2")t[n] -= e.width / 2; else if (n === "y1" || n === "y2")t[n] -= e.height / 2
        }
    }
    ...
    fabric.Gradient = fabric.util.createClass({
        initialize: function (e) {
            ...
            return {x1: this.x1, x2: this.x2, y1: this.y1, y2: this.y2, colorStops: this.colorStops}
        ...
        fromElement: function (n, r) {
            var i = n.getElementsByTagName("stop"), s, o = {}, u = {
            ...
            return t(r, u), new fabric.Gradient({x1: u.x1, y1: u.y1, x2: u.x2, y2: u.y2, colorStops: o})
    ...
    fabric.StaticCanvas = function (e, t) {
        ...
        _draw: function (e, t) {
            ...
            if (this.controlsAboveOverlay) {
                var n = t.hasBorders, r = t.hasCorners;
        ...
        renderAll: function (e) {
            ...
            var n = this.getActiveGroup(), r = new Date;
        ...
        drawControls: function (e) {
            ...
            if (t)e.save(), fabric.Group.prototype.transform.call(t, e), t.drawBorders(e).drawCorners(e), e.restore(); else for (var n = 0, r = this._objects.length; n < r; ++n) {
        ...
        toDataURLWithMultiplier: function (e, t, n) {
            var r = this.getWidth(), i = this.getHeight(), s = r * t, o = i * t, u = this.getActiveObject(), a = this.getActiveGroup();
        ...
        remove: function (e) {
            return n(this._objects, e), this.getActiveObject() === e && (this.fire("before:selection:cleared", {target: e}), this.discardActiveObject(), this.fire("selection:cleared")), this.renderAll(), e
        },
        ...
        sendBackwards: function (e) {
            ...
            if (t !== 0) {
                for (var i = t - 1; i >= 0; --i)if (e.intersectsWithObject(this._objects[i]) || e.isContainedWithinObject(this._objects[i])) {
                    r = i;
                    break
                }
        ...
        bringForward: function (e) {
            ...
            if (r !== t.length - 1) {
                for (var s = r + 1, o = this._objects.length; s < o; ++s)if (e.intersectsWithObject(t[s]) || e.isContainedWithinObject(this._objects[s])) {
                    i = s;
                    break
                }
        ...
        EMPTY_JSON: '{"objects": [], "background": "white"}', toGrayscale: function (e) {
    ...
    var e = fabric.util.object.extend, t = fabric.util.getPointer, n = fabric.util.addListener, r = fabric.util.removeListener, i = {
        tr: "ne-resize",
        br: "se-resize",
        bl: "sw-resize",
        tl: "nw-resize",
        ...
        mr: "e-resize",
        mb: "s-resize"
    }, s = fabric.util.array.min, o = fabric.util.array.max, u = Math.sqrt, a = Math.pow, f = Math.atan2, l = Math.abs, c = Math.min, h = Math.max, p = .5;
    ...
    var v = {
        ...
        __onMouseUp: function (e) {
            ...
            if (this.isDrawingMode && this._isCurrentlyDrawing) {
                this._finalizeDrawingPath(), this.fire("mouse:up", {e: e});
                return
            }
            if (this._currentTransform) {
                ...
                this.stateful && t.hasStateChanged() && (t.isMoving = !1, this.fire("object:modified", {target: t}), t.fire("modified"))
            }
        ...
        __onMouseDown: function (e) {
            ...
            if (this.isDrawingMode) {
                this._prepareForDrawing(e),
                    this._captureDrawingPath(e), this.fire("mouse:down", {e: e});
                return
            }
            if (this._currentTransform)return;
            var n = this.findTarget(e), r = this.getPointer(e), i = this.getActiveGroup(), s;
            if (this._shouldClearSelection(e))this._groupSelector = {
                ex: r.x,
                ey: r.y,
                top: 0,
                left: 0
            }, this.deactivateAllWithDispatch(); else {
            ...
            this.renderAll(), this.fire("mouse:down", {target: n, e: e}), n && n.fire("mousedown", {e: e})
        },
        __onMouseMove: function (e) {
            var n;
            if (this.isDrawingMode) {
                this._isCurrentlyDrawing && this._captureDrawingPath(e), this.fire("mouse:move", {e: e});
                return
            }
            var r = this._groupSelector, i;
            if (r !== null)i = t(e), r.left = i.x - this._offset.left - r.ex, r.top = i.y - this._offset.top - r.ey, this.renderTop(); else if (!this._currentTransform) {
        ...
        _shouldClearSelection: function (e) {
            var t = this.findTarget(e), n = this.getActiveGroup();
        ...
        _setupCurrentTransform: function (e, n) {
            ...
            }, this._currentTransform.original = {left: n.left, top: n.top}
        },
        ...
        _finalizeDrawingPath: function () {
            ...
            var e = s(this._freeDrawingXPoints), t = s(this._freeDrawingYPoints), n = o(this._freeDrawingXPoints), r = o(this._freeDrawingYPoints), i = [], u = this._freeDrawingXPoints, a = this._freeDrawingYPoints;
            ...
            c.fill = null, c.stroke = this.freeDrawingColor, c.strokeWidth = this.freeDrawingLineWidth, this.add(c), c.set("left", e + (n - e) / 2).set("top", t + (r - t) / 2).setCoords(), this.renderAll(), this.fire("path:created", {path: c})
        },
        ...
        _scaleObject: function (e, t, n) {
            var r = this._currentTransform, i = this._offset, s = r.target;
            if (s.lockScalingX && s.lockScalingY)return;
            var o = u(a(r.ey - r.top - i.top, 2) + a(r.ex - r.left - i.left, 2)), f = u(a(t - r.top - i.top, 2) + a(e - r.left - i.left, 2));
        ...
        _rotateObject: function (e, t) {
            var n = this._currentTransform, r = this._offset;
            if (n.target.lockRotation)return;
            var i = f(n.ey - n.top - r.top, n.ex - n.left - r.left), s = f(t - n.top - r.top, e - n.left - r.left);
        ...
        _setCursorFromEvent: function (e, t) {
            ...
            var r = this.getActiveGroup(), s = !!t._findTargetCorner && (!r || !r.contains(t)) && t._findTargetCorner(e, this._offset);
            if (!s)n.cursor = this.hoverCursor; else if (s in i)n.cursor = i[s]; else {
        ...
        _drawSelection: function () {
            var e = this._groupSelector, t = e.left, n = e.top, r = l(t), i = l(n);
        ...
        _findSelectedObjects: function (e) {
            var t = [], n = this._groupSelector.ex, r = this._groupSelector.ey, i = n + this._groupSelector.left, s = r + this._groupSelector.top, o, u = new fabric.Point(c(n, i), c(r, s)), a = new fabric.Point(h(n, i), h(r, s));
        ...
        findTarget: function (e, t) {
            var n, r = this.getPointer(e), i = this.getActiveGroup();
            if (i && !t && this.containsPoint(e, i))return n = i, n;
            var s = [];
            for (var o = this._objects.length; o--;)if (this._objects[o] && this.containsPoint(e, this._objects[o])) {
    ...
    loadFromDatalessJSON: function (e, t) {
        ...
        function r(e, t) {
            var r = e.paths ? "paths" : "path", i = e[r];
            delete e[r];
            if (typeof i != "string")if (e.type === "image")fabric[fabric.util.string.capitalize(e.type)].fromObject(e, function (e) {
                n(e, t)
            }); else {
            ...
            }); else if (e.type === "text")if (e.useNative)n(fabric.Text.fromObject(e), t); else {
                e.path = i;
    ...
    "use strict";
    var t = e.fabric || (e.fabric = {}), n = t.util.object.extend, r = t.util.toFixed, i = t.util.string.capitalize, s = t.util.getPointer, o = t.util.degreesToRadians, u = Array.prototype.slice;
    if (t.Object)return;
    t.Object = t.util.createClass({
        ...
        setOptions: function (e) {
            var t = this.stateProperties.length, n;
        ...
        toObject: function () {
            var e = t.Object.NUM_FRACTION_DIGITS, n = {
                type: this.type,
                left: r(this.left, e),
                top: r(this.top, e),
        ...
        setCoords: function () {
            var e = this.strokeWidth > 1 ? this.strokeWidth : 0, t = this.padding;
            ...
            var n = Math.cos(this._angle + this._theta) * this._hypotenuse, r = Math.sin(this._angle + this._theta) * this._hypotenuse, i = this._theta, s = Math.sin(i), o = Math.cos(i), u = {
                x: this.left - n,
                y: this.top - r
            }, a = {
            ...
            }, v = {x: u.x + this.currentWidth / 2 * o, y: u.y + this.currentWidth / 2 * s};
            return this.oCoords = {
                tl: u,
                tr: a,
                br: f,
        ...
        getBoundingRectWidth: function () {
            ...
            var e = [this.oCoords.tl.x, this.oCoords.tr.x, this.oCoords.br.x, this.oCoords.bl.x], n = t.util.array.min(e), r = t.util.array.max(e);
            return Math.abs(n - r)
        },
        getBoundingRectHeight: function () {
            this.oCoords || this.setCoords();
            var e = [this.oCoords.tl.y, this.oCoords.tr.y, this.oCoords.br.y, this.oCoords.bl.y], n = t.util.array.min(e), r = t.util.array.max(e);
            return Math.abs(n - r)
        },
        drawBorders: function (e) {
            if (!this.hasBorders)return;
            var n = t.Object.MIN_SCALE_LIMIT, r = this.padding, i = r * 2, s = this.strokeWidth > 1 ? this.strokeWidth : 0;
            e.save(), e.globalAlpha = this.isMoving ? this.borderOpacityWhenMoving : 1, e.strokeStyle = this.borderColor;
            var o = 1 / (this.scaleX < n ? n : this.scaleX), u = 1 / (this.scaleY < n ? n : this.scaleY);
            e.lineWidth = 1 / this.borderScaleFactor, e.scale(o, u);
            var a = this.getWidth(), f = this.getHeight();
        ...
        _renderDashedStroke: function (e) {
            function u(u, a) {
                var f = 0, l = 0, c = (a ? i.height : i.width) + s * 2;
                while (f < c) {
            ...
            var t = 0, n = -this.width / 2, r = -this.height / 2, i = this, s = this.padding, o = this.strokeDashArray.length;
        ...
        intersectsWithRect: function (e, n) {
            var r = this.oCoords, i = new t.Point(r.tl.x, r.tl.y), s = new t.Point(r.tr.x, r.tr.y), o = new t.Point(r.bl.x, r.bl.y), u = new t.Point(r.br.x, r.br.y), a = t.Intersection.intersectPolygonRectangle([i, s, u, o], e, n);
        ...
        intersectsWithObject: function (e) {
            ...
            var r = n(this.oCoords), i = n(e.oCoords), s = t.Intersection.intersectPolygonPolygon([r.tl, r.tr, r.br, r.bl], [i.tl, i.tr, i.br, i.bl]);
        ...
        isContainedWithinRect: function (e, n) {
            var r = this.oCoords, i = new t.Point(r.tl.x, r.tl.y), s = new t.Point(r.tr.x, r.tr.y), o = new t.Point(r.bl.x, r.bl.y);
        ...
        _findTargetCorner: function (e, t) {
            ...
            var n = s(e), r = n.x - t.left, i = n.y - t.top, o, u;
        ...
        _setCornerCoords: function () {
            var e = this.oCoords, t = o(45 - this.getAngle()), n = Math.sqrt(2 * Math.pow(this.cornersize, 2)) / 2, r = n * Math.cos(t), i = n * Math.sin(t), s = Math.sin(this._theta), u = Math.cos(this._theta);
            e.tl.corner = {
                tl: {x: e.tl.x - i, y: e.tl.y - r},
                tr: {x: e.tl.x + r, y: e.tl.y - i},
                bl: {x: e.tl.x - r, y: e.tl.y + i},
                br: {x: e.tl.x + i, y: e.tl.y + r}
            }, e.tr.corner = {
                tl: {x: e.tr.x - i, y: e.tr.y - r},
                tr: {x: e.tr.x + r, y: e.tr.y - i},
                br: {x: e.tr.x + i, y: e.tr.y + r},
                bl: {x: e.tr.x - r, y: e.tr.y + i}
            }, e.bl.corner = {
                tl: {x: e.bl.x - i, y: e.bl.y - r},
                bl: {x: e.bl.x - r, y: e.bl.y + i},
                br: {x: e.bl.x + i, y: e.bl.y + r},
                tr: {x: e.bl.x + r, y: e.bl.y - i}
            }, e.br.corner = {
                tr: {x: e.br.x + r, y: e.br.y - i},
                bl: {x: e.br.x - r, y: e.br.y + i},
                br: {x: e.br.x + i, y: e.br.y + r},
                tl: {x: e.br.x - i, y: e.br.y - r}
            }, e.ml.corner = {
                tl: {x: e.ml.x - i, y: e.ml.y - r},
                tr: {x: e.ml.x + r, y: e.ml.y - i},
                bl: {x: e.ml.x - r, y: e.ml.y + i},
                br: {x: e.ml.x + i, y: e.ml.y + r}
            }, e.mt.corner = {
                tl: {x: e.mt.x - i, y: e.mt.y - r},
                tr: {x: e.mt.x + r, y: e.mt.y - i},
                bl: {x: e.mt.x - r, y: e.mt.y + i},
                br: {x: e.mt.x + i, y: e.mt.y + r}
            }, e.mr.corner = {
                tl: {x: e.mr.x - i, y: e.mr.y - r},
                tr: {x: e.mr.x + r, y: e.mr.y - i},
                bl: {x: e.mr.x - r, y: e.mr.y + i},
                br: {x: e.mr.x + i, y: e.mr.y + r}
            }, e.mb.corner = {
                tl: {x: e.mb.x - i, y: e.mb.y - r},
                tr: {x: e.mb.x + r, y: e.mb.y - i},
                bl: {x: e.mb.x - r, y: e.mb.y + i},
                br: {x: e.mb.x + i, y: e.mb.y + r}
            }, e.mtr.corner = {
                tl: {
                    x: e.mtr.x - i + s * this.rotatingPointOffset,
                    y: e.mtr.y - r - u * this.rotatingPointOffset
                },
                tr: {x: e.mtr.x + r + s * this.rotatingPointOffset, y: e.mtr.y - i - u * this.rotatingPointOffset},
                bl: {x: e.mtr.x - r + s * this.rotatingPointOffset, y: e.mtr.y + i - u * this.rotatingPointOffset},
                br: {x: e.mtr.x + i + s * this.rotatingPointOffset, y: e.mtr.y + r - u * this.rotatingPointOffset}
            }
        },
        toGrayscale: function () {
            var e = this.get("fill");
        ...
        animate: function () {
            if (arguments[0] && typeof arguments[0] == "object")for (var e in arguments[0])this._animate(e, arguments[0][e], arguments[1]); else this._animate.apply(this, arguments);
            return this
        },
    ...
    for (var f = a.stateProperties.length; f--;) {
        var l = a.stateProperties[f], c = l.charAt(0).toUpperCase() + l.slice(1), h = "set" + c, p = "get" + c;
        a[p] || (a[p] = function (e) {
    ...
    n(t.Object.prototype, t.Observable), n(t.Object, {NUM_FRACTION_DIGITS: 2, MIN_SCALE_LIMIT: .1})
}(typeof exports != "undefined" ? exports : this), function (e) {
    "use strict";
    var t = e.fabric || (e.fabric = {}), n = t.util.object.extend, r = {x1: 1, x2: 1, y1: 1, y2: 1};
    if (t.Line) {
        t.warn("fabric.Line is already defined");
        return
    }
    t.Line = t.util.createClass(t.Object, {
        type: "line", initialize: function (e, t) {
    ...
    t.Triangle = t.util.createClass(t.Object, {
        type: "triangle", initialize: function (e) {
            ...
            var e = this.width / 2, t = this.height / 2, n = [-e + " " + t, "0 " + -t, e + " " + t].join(",");
    ...
    t.Ellipse = t.util.createClass(t.Object, {
        type: "ellipse", initialize: function (e) {
            ...
            return r(this.callSuper("toObject"), {rx: this.get("rx"), ry: this.get("ry")})
        }, toSVG: function () {
    ...
    t.Rect = t.util.createClass(t.Object, {
        type: "rect", rx: 0, ry: 0, initialize: function (e) {
            ...
            var t = this.rx || 0, n = this.ry || 0, r = -this.width / 2, i = -this.height / 2, s = this.width, o = this.height;
            ...
            return t.util.object.extend(this.callSuper("toObject"), {rx: this.get("rx") || 0, ry: this.get("ry") || 0})
        }, toSVG: function () {
    ...
    t.Polyline = t.util.createClass(t.Object, {
        type: "polyline", initialize: function (e, t) {
    ...
    t.Polygon = t.util.createClass(t.Object, {
        type: "polygon", initialize: function (e, t) {
            ...
            return n(this.callSuper("toObject"), {points: this.points.concat()})
        }, toSVG: function () {
            var e = [];
    ...
    f.Path = f.util.createClass(f.Object, {
        type: "path", initialize: function (e, t) {
            ...
            var t = "width"in e, n = "height"in e;
            this.path = this._parsePath();
            if (!t || !n)h(this, this._parseDimensions()), t && (this.width = e.width), n && (this.height = e.height)
        }, _render: function (e) {
            var t, r = null, i = 0, s = 0, o = 0, u = 0, a, f, l, c, h = -(this.width / 2), p = -(this.height / 2);
            ...
            var e = h(this.callSuper("toObject"), {path: this.path});
            ...
            for (var s = 0, o, u = this.path.length; s < u; s++) {
                ...
                var l = o[0].toLowerCase(), c = t[l];
                if (o.length - 1 > c)for (var h = 1, p = o.length; h < p; h += c)e.push([o[0]].concat(o.slice(h, h + c))); else e.push(o)
            }
            return e
            ...
            var u = l(e), a = l(t), f = 0, h = 0, p = {top: a - h, left: u - f, bottom: c(t) - h, right: c(e) - f};
    ...
    t.PathGroup = t.util.createClass(t.Path, {
        ...
        toObject: function () {
            return n(i.call(this), {paths: r(this.getObjects(), "toObject"), sourcePath: this.sourcePath})
        },
        toDatalessObject: function () {
            var e = this.toObject();
        ...
        toSVG: function () {
            var e = this.getObjects(), t = ["<g ", 'width="', this.width, '" ', 'height="', this.height, '" ', 'style="', this.getSvgStyles(), '" ', 'transform="', this.getSvgTransform(), '" ', ">"];
    ...
    "use strict";
    var t = e.fabric || (e.fabric = {}), n = t.util.object.extend, r = t.util.array.min, i = t.util.array.max, s = t.util.array.invoke, o = t.util.removeFromArray;
    if (t.Group)return;
    t.Group = t.util.createClass(t.Object, {
        type: "group", initialize: function (e, t) {
            ...
            return n(this.callSuper("toObject"), {objects: s(this.objects, "toObject")})
        }, render: function (e, t) {
            e.save(), this.transform(e);
            var n = Math.max(this.scaleX, this.scaleY);
            for (var r = 0, i = this.objects.length; r < i; r++) {
                var s = this.objects[r], o = s.borderScaleFactor;
        ...
        }, forEachObject: t.StaticCanvas.prototype.forEachObject, _setOpacityIfSame: function () {
            var e = this.getObjects(), t = e[0] ? e[0].get("opacity") : 1, n = e.every(function (e) {
                return e.get("opacity") === t
            });
            n && (this.opacity = t)
        }, _calcBounds: function () {
            var e = [], t = [], n, s, o, u, a, f, l, c = 0, h = this.objects.length;
            for (; c < h; ++c) {
            ...
            var t = this.get("width") / 2, n = this.get("height") / 2, r = this.get("left"), i = this.get("top");
    ...
    fabric.Image = fabric.util.createClass(fabric.Object, {
        active: !1, type: "image", initialize: function (e, t) {
            ...
            var t = typeof Buffer != "undefined" && typeof window == "undefined", n = this._originalImage, r = fabric.document.createElement("canvas"), i = t ? new (require("canvas").Image) : fabric.document.createElement("img"), s = this;
    ...
    type: "RemoveWhite", initialize: function (e) {
    ...
    type: "Invert", applyTo: function (e) {
    ...
    type: "Sepia2", applyTo: function (e) {
    ...
    type: "Brightness", initialize: function (e) {
    ...
    type: "Noise", initialize: function (e) {
    ...
    type: "Tint", initialize: function (e) {
    ...
    "use strict";
    var t = e.fabric || (e.fabric = {}), n = t.util.object.extend, r = t.util.object.clone, i = t.util.toFixed;
    if (t.Text) {
    ...
    t.Text = t.util.createClass(t.Object, {
        ...
        _setBoundaries: function (e, t) {
            ...
            for (var n = 0, r = t.length; n < r; n++) {
                var i = e.measureText(t[n]).width, s = this._getLineLeftOffset(i);
                this._boundaries.push({height: this.fontSize, width: i, left: s})
            }
        },
        ...
        _renderTextStroke: function (e, t) {
            if (this.strokeStyle)for (var n = 0, r = t.length; n < r; n++)e.strokeText(t[n], -this.width / 2, -this.height / 2 + n * this.fontSize * this.lineHeight)
        },
        ...
        _renderTextDecoration: function (e, t) {
            function i(i) {
                for (var s = 0, o = t.length; s < o; s++) {
                    var u = e.measureText(t[s]).width, a = r._getLineLeftOffset(u);
    ...
    function request(e, t, n) {
        var r = URL.parse(e), i = HTTP.createClient(r.port, r.hostname), s = i.request("GET", r.pathname, {host: r.hostname});
    ...
    var DOMParser = (new require("xmldom")).DOMParser, URL = require("url"), HTTP = require("http"), Canvas = require("canvas"), Image = require("canvas").Image;
